  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "user-bubble": "hsl(var(--surface-user-bubble))",
        "bot-bubble": "hsl(var(--surface-bot-bubble))",
        "user-bubble-text": "hsl(var(--text-user-bubble))",
        "bot-bubble-text": "hsl(var(--text-bot-bubble))",
